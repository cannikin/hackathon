...
Reward.create :id => 1, :value => '20', :title => '20% off your next purchase', :description => "Welcome to the Running Shack! As a thank you for being a new customer take 20% off your next purchase!", :value => "20%", :on_visit => 1, :device_id => 1
Reward.create :id => 2, :value => '10', :title => '10% off your next purchase', :description => "For being such a loyal customer, here's 10% off your next purchase!", :value => "10%", :every_visit => 5, :device_id => 1
...
Notification.create :id => 1, :hit_id => 1, :reward_id => 1, :created_at => 3.days.ago
Notification.create :id => 2, :hit_id => 5, :reward_id => 2, :created_at => 2.days.ago
Notification.create :id => 3, :hit_id => 10, :reward_id => 2, :created_at => 5.hours.ago
Notification.create :id => 4, :hit_id => 15, :reward_id => 2, :created_at => 1.hour.ago
...
Notification.create :id => 5, :hit_id => 16, :reward_id => 1, :created_at => 5.days.ago
Notification.create :id => 6, :hit_id => 20, :reward_id => 2, :created_at => 9.hours.ago
Notification.create :id => 7, :hit_id => 25, :reward_id => 2, :created_at => 4.minutes.ago
...
Notification.create :id => 8, :hit_id => 28, :reward_id => 1, :created_at => 6.days.ago
Notification.create :id => 9, :hit_id => 32, :reward_id => 2, :created_at => 2.days.ago
Notification.create :id => 10, :hit_id => 37, :reward_id => 2, :created_at => 45.minutes.ago
...
Notification.create :id => 11, :hit_id => 38, :reward_id => 1, :created_at => 1.day.ago
Notification.create :id => 12, :hit_id => 42, :reward_id => 2, :created_at => 15.minutes.ago
